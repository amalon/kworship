...
SET(UNO_OO_SDK_BINS "${UNO_OO_SDK_HOME}/linux/bin" "${UNO_OO_SDK_HOME}/bin")
SET(UNO_IDL_PATH "${UNO_OO_SDK_HOME}/idl")
SET(UNO_INCLUDES "${UNO_OO_SDK_HOME}/include")
SET(UNO_OO_PROGRAM "${UNO_OO_HOME}/program")
# Files
FIND_FILE(UNO_OO_TYPES_RDB "types.rdb" PATHS "${UNO_OO_PROGRAM}" "${UNO_OO_HOME}/basis-link/ure-link/share/misc")
# Programs
...
FIND_PROGRAM(UNO_REGCOMP   NAMES "regcomp" "regcompare" PATHS ${UNO_OO_SDK_BINS})
...
IF (${CMAKE_SYSTEM_NAME} STREQUAL "Linux")
  ...
  SET(UNO_TOOL_ENV env LD_LIBRARY_PATH=${UNO_OO_PROGRAM}:${UNO_OO_SDK_HOME}/linux/lib:${UNO_OO_HOME}/basis-link/ure-link/lib)
...
# Libraries
SET(UNO_LIB_PATHS "${UNO_OO_PROGRAM}" "${UNO_OO_HOME}/basis-link/ure-link/lib")
FIND_LIBRARY(UNO_SAL_LIB        NAMES uno_sal                       PATHS ${UNO_LIB_PATHS}) 
FIND_LIBRARY(UNO_CPPU_LIB       NAMES uno_cppu                      PATHS ${UNO_LIB_PATHS}) 
FIND_LIBRARY(UNO_CPPUHELPER_LIB NAMES uno_cppuhelper${UNO_CPPU_ENV} PATHS ${UNO_LIB_PATHS}) 
FIND_LIBRARY(UNO_SALHELPER_LIB  NAMES uno_salhelper${UNO_CPPU_ENV}  PATHS ${UNO_LIB_PATHS}) 
FIND_LIBRARY(UNO_REG_LIB        NAMES reg                           PATHS ${UNO_LIB_PATHS}) 
FIND_LIBRARY(UNO_STORE_LIB      NAMES store                         PATHS ${UNO_LIB_PATHS}) 
...
#      ${UNO_SAL_LIB}
  ...
  MACRO (UNO_ADD_TYPES sourcevar)
    ...
    ADD_CUSTOM_COMMAND(
      ...
      COMMAND ${UNO_TOOL_ENV} ${UNO_REGMERGE} ${UNO_RDB} / ${UNO_OO_TYPES_RDB}
